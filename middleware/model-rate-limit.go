...
func redisRateLimitHandler(duration int64, totalMaxCount, successMaxCount int) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if totalMaxCount > 0 {
			...
			if !allowed {
				abortWithOpenAiMessage(c, http.StatusTooManyRequests, fmt.Sprintf("You have reached the total request limit: a maximum of %d requests within %d minutes, including failed requests. Please check if your requests are correct.", totalMaxCount, setting.ModelRequestRateLimitDurationMinutes))
			}
		}
