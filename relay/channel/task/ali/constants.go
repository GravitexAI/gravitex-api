...
var ModelList = []string{
	...
	"wan2.7-i2v", // 万相2.7图生视频专业版
	"wan2.7-r2v", // 万相2.7参考生视频专业版
	// wan2.6 系列（最新）
	"wan2.6-t2v",       // 万相2.6文生视频
	"wan2.6-i2v-flash", // 万相2.6图生视频极速版（有声/无声可选）
	"wan2.6-i2v",       // 万相2.6图生视频专业版
	"wan2.6-r2v-flash", // 万相2.6参考生视频极速版（有声/无声可选）
	"wan2.6-r2v",       // 万相2.6参考生视频专业版
	// wan2.5 系列
