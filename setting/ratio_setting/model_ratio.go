...
var defaultModelRatio = map[string]float64{
	...
	"claude-opus-4-9":                           2.5,
	"claude-opus-4-9-max":                       2.5,
	"claude-opus-4-9-xhigh":                     2.5,
	"claude-opus-4-9-high":                      2.5,
	"claude-opus-4-9-medium":                    2.5,
	"claude-opus-4-9-low":                       2.5,
	"claude-opus-4-10":                          2.5,
	"claude-opus-4-10-max":                      2.5,
	"claude-opus-4-10-xhigh":                    2.5,
	"claude-opus-4-10-high":                     2.5,
	"claude-opus-4-10-medium":                   2.5,
	"claude-opus-4-10-low":                      2.5,
