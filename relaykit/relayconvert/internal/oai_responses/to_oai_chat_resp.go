...
func usageFromResponsesUsage(src *dto.Usage, createBillingSnapshot bool) *dto.Usage {
	...
	if src.InputTokensDetails != nil {
		...
		if src.InputTokensDetails.CachedTokensDetails != nil {
			details := *src.InputTokensDetails.CachedTokensDetails
			usage.PromptTokensDetails.CachedTokensDetails = &details
		}
