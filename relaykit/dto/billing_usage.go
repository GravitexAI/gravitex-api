...
func HasOpenAIUsageTokens(usage *Usage) bool {
	...
	return usage.InputTokensDetails.CachedTokens != 0 ||
		...
		usage.InputTokensDetails.AudioTokens != 0 || usage.InputTokensDetails.VideoTokens != 0
}
...
func NewEstimatedGeminiChatBillingUsage(usage *Usage) *BillingUsage {
	...
	for _, detail := range []GeminiPromptTokensDetails{
		...
		{Modality: "VIDEO", TokenCount: usage.PromptTokensDetails.VideoTokens},
...
func (usage *BillingUsage) canonicalClaudeUsage() *Usage {
	...
	canonical.CompletionTokenDetails.ReasoningTokens = claudeUsage.GetThinkingTokens()
...
func (usage *BillingUsage) canonicalGeminiUsage() *Usage {
	...
	if canonical.PromptTokens > 0 && canonical.PromptTokensDetails.TextTokens == 0 && canonical.PromptTokensDetails.AudioTokens == 0 && canonical.PromptTokensDetails.ImageTokens == 0 && canonical.PromptTokensDetails.VideoTokens == 0 {
