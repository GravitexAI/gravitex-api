...
func InitOptionMap() {
	...
	common.OptionMap["LogUpstreamResponsesEnabled"] = "false"
	common.OptionMap["LogUsageConversionEnabled"] = "false"
	...
	common.OptionMap["AutoRouter"] = setting.AutoRouter2JsonString()
...
func validateOptionValue(key string, value string) error {
	...
	if key == "AutoRouter" {
		return setting.ValidateAutoRouterJSON(value)
	}
	return nil
}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AutoRouter":
		err = setting.UpdateAutoRouterByJsonString(value)
